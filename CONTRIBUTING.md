...
application, document it in the [README](https://github.com/Comcast/seshat/blob/master/README.md) or [wiki](https://github.com/Comcast/seshat/wiki)! This includes new features, additional variants of behavior and breaking changes.
